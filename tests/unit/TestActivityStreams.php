...
class TestActivityStreams extends TestCase
{
    ...
    public function testSetProperties()
    {
        ...
        $this->assertEquals([Properties::ID[1]], $as2->getContext());
        ...
        $as2->setProperty(["object", "http://example.com"], "object value");
        $as2->setProperty(["subject", "http://example.com"], "subject value");
        $this->assertEquals("object value", $as2->getDoc()["object"]);
        $this->assertEquals("subject value", $as2->getDoc()["subject"]);
        $this->assertEquals([Properties::ID[1], "http://example.com"], $as2->getContext());

        $as2->setProperty(["foaf:name", ["foaf", "http://xmlns.com/foaf/0.1"]], "name value");
        $as2->setProperty(["foaf:email", ["foaf", "http://xmlns.com/foaf/0.1"]], "email value");
        $this->assertEquals("name value", $as2->getDoc()["foaf:name"]);
        $this->assertEquals("email value", $as2->getDoc()["foaf:email"]);
        $this->assertEquals([Properties::ID[1], "http://example.com", ["foaf" => "http://xmlns.com/foaf/0.1"]], $as2->getContext());
    }
    ...
    public function testGetProperties()
    {
        ...
        $this->assertEquals("object value", $as2->getProperty(["object", "http://example.com"]));
        $this->assertEquals("object value", $as2->getProperty("object"));
        $this->assertEquals("name value", $as2->getProperty(["foaf:name", ["foaf", "http://xmlns.com/foaf/0.1"]]));
